...
export function EffluentPDF({ certificate, results }: EffluentPDFProps) {
  ...
  // Determine which standards to use based on effluent_type
  const effluent_type = certificate.effluent_type || "environment";
  const isPublicSewers = effluent_type === "public_sewers";
    ...
    parameters: [
      {
        ...
        unit: "pH units",
        standard: isPublicSewers ? "6.0-9.0" : "6.5-8.5",
      ...
      },
      {
        ...
        method: "APHA 2550-B",
        unit: "°C",
        standard: isPublicSewers ? "20-35" : "±3",
      ...
      },
      {
        ...
        method: "APHA 2540-D",
        unit: "mg/L",
        standard: isPublicSewers ? "250" : "30",
      ...
      },
      {
        ...
        method: "APHA 2540-C",
        unit: "mg/L",
        standard: isPublicSewers ? "2000" : "1200",
    ...
    parameters: [
      {
        ...
        method: "APHA 5210-B",
        unit: "mg/L",
        standard: isPublicSewers ? "500" : "30",
      ...
      },
      {
        ...
        method: "APHA 5220-B",
        unit: "mg/L",
        standard: isPublicSewers ? "1000" : "50",
      ...
      },
      {
        ...
        unit: "mg/L",
        standard: isPublicSewers ? "250" : "250",
      ...
      },
      {
        ...
        unit: "mg/L",
        standard: isPublicSewers ? "10" : "1.5",
      ...
      },
      {
        ...
        unit: "mg/L",
        standard: isPublicSewers ? "1.0" : "0.1",
      ...
      },
      {
        ...
        method: "APHA 5530-D",
        unit: "mg/L",
        standard: isPublicSewers ? "10" : "0.001",
    ...
    parameters: [
      {
        ...
        method: "APHA 3114-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.5" : "0.02",
      ...
      },
      {
        ...
        method: "APHA 4500-B",
        unit: "mg/L",
        standard: isPublicSewers ? "5.0" : "1.0",
      ...
      },
      {
        ...
        method: "APHA 3111-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.5" : "0.01",
      ...
      },
      {
        ...
        method: "APHA 3111-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.05" : "0.05",
      ...
      },
      {
        ...
        method: "APHA 3111-B",
        unit: "mg/L",
        standard: isPublicSewers ? "1.0" : "1.0",
      ...
      },
      {
        ...
        method: "APHA 3111-B",
        unit: "mg/L",
        standard: isPublicSewers ? "10.0" : "2.0",
      ...
      },
      {
        ...
        method: "APHA 3111-B",
        unit: "mg/L",
        standard: isPublicSewers ? "1.0" : "0.01",
      ...
      },
      {
        ...
        method: "APHA 3111-B",
        unit: "mg/L",
        standard: isPublicSewers ? "10.0" : "0.1",
      ...
      },
      {
        ...
        method: "APHA 3112-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.05" : "0.005",
      ...
      },
      {
        ...
        method: "APHA 3111-B",
        unit: "mg/L",
        standard: isPublicSewers ? "3.0" : "0.3",
      ...
      },
      {
        ...
        method: "APHA 3114-B",
        unit: "mg/L",
        standard: isPublicSewers ? "1.0" : "0.02",
      ...
      },
      {
        ...
        method: "APHA 3111-B",
        unit: "mg/L",
        standard: isPublicSewers ? "5.0" : "0.5",
    ...
    parameters: [
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "3.0" : "3.0",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.06" : "0.06",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.2" : "0.2",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.04" : "0.04",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.02" : "0.02",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.1" : "0.01",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.4" : "0.4",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.2" : "0.06",
      ...
      },
      {
        ...
        method: "APHA 6410-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.002" : "0.002",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.1" : "0.04",
      ...
      },
      {
        ...
        method: "APHA 6200-B",
        unit: "mg/L",
        standard: isPublicSewers ? "0.3" : "0.07",
    ...
    parameters: [
      {
        ...
        method: "APHA 9223-B",
        unit: "MPN/100ml",
        standard: isPublicSewers ? "Nil" : "Nil",
      ...
      },
      {
        ...
        method: "APHA 9223-B",
        unit: "MPN/100ml",
        standard: isPublicSewers ? "1000" : "30",
